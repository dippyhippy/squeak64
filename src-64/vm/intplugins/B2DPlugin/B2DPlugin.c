/* Automatically generated from Squeak on #(29 October 2004 2:51:05 pm) */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"B2DPlugin 29 October 2004 (i)"
#else
	"B2DPlugin 29 October 2004 (e)"
#endif
;
...
static sqInt bitmapValuebitsatXy(sqInt bmFill, sqInt bits, sqInt xp, sqInt yp) {
	...
	if (bmDepth == 32) {
		...
		if ((value != 0) && ((value & 4278190080ULL) == 0)) {
			value = value | 4278190080ULL;
		}
	...
	while (x < lastPixel) {
		...
		if ((xp >= 0) && ((yp >= 0) && ((xp < bmWidth) && (yp < bmHeight)))) {
			...
			if (bmDepth1 == 32) {
				...
				if ((value1 != 0) && ((value1 & 4278190080ULL) == 0)) {
					value1 = value1 | 4278190080ULL;
				}
	...
	while (x < rightX) {
		...
		if ((xp >= 0) && ((yp >= 0) && ((xp < bmWidth) && (yp < bmHeight)))) {
			...
			if (bmDepth2 == 32) {
				...
				if ((value2 != 0) && ((value2 & 4278190080ULL) == 0)) {
					value2 = value2 | 4278190080ULL;
				}
...
static sqInt isFill(sqInt fill) {
	return ((fill & 4278190080ULL) != 0) || ((((objBuffer[fill + GEObjectType]) & GEPrimitiveTypeMask) & GEPrimitiveFillMask) != 0);
}

static sqInt isFillColor(sqInt fill) {
	return (fill & 4278190080ULL) != 0;
}

static sqInt isFillOkay(sqInt fill) {
	return (fill == 0) || (((fill & 4278190080ULL) != 0) || (((fill >= 0) && (fill < objUsed)) && (((fill & 4278190080ULL) != 0) || ((((objBuffer[fill + GEObjectType]) & GEPrimitiveTypeMask) & GEPrimitiveFillMask) != 0))));
}
...
static sqInt setAALevel(sqInt level) {
	...
	if (aaLevel == 1) {
		...
		workBuffer[GWAAColorMask] = 4294967295ULL;
...
static sqInt transformColor(sqInt fillIndex) {
	...
	if (!((fillIndex == 0) || ((fillIndex & 4278190080ULL) != 0))) {
		return fillIndex;
	}
	b = fillIndex & 255;
